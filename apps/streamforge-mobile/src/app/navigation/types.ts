...
export type LoginScreenProps         = NativeStackScreenProps<OnboardingStackParamList, 'Login'>
export type RegisterScreenProps      = NativeStackScreenProps<OnboardingStackParamList, 'Register'>
export type VerifyEmailScreenProps   = NativeStackScreenProps<OnboardingStackParamList, 'VerifyEmail'>
export type ForgotPasswordScreenProps = NativeStackScreenProps<OnboardingStackParamList, 'ForgotPassword'>
export type LiveStudioScreenProps    = NativeStackScreenProps<StudioStackParamList, 'LiveStudio'>
export type EditorCanvasScreenProps  = NativeStackScreenProps<EditorStackParamList, 'EditorCanvas'>
export type ExportProgressScreenProps = NativeStackScreenProps<EditorStackParamList, 'ExportProgress'>
